...
- **Add telemetry / counters for core failures** `[PM, TL]` — Add counters for `FindResult.NoBpmCandidates`, `FindResult.NoSpotifyMatch`, and watch dropouts (PM). Complements the UXR P0 telemetry; consolidate into one logging surface.
